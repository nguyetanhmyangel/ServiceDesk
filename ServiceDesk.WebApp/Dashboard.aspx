<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="ServiceDesk.WebApp.Dashboard" %>
                    ...
                    <div class="databox bg-white radius-bordered">
                        ...
                        <div class="databox-right padding-top-20">
                            <div class="databox-stat palegreen">
                                Admin<i class="stat-icon icon-xlg fa fa-phone"></i>
                            </div>
                            <div class="databox-text darkgray">Contact Admin</div>
                            <div class="databox-text darkgray">Telephone: 2523 - 2491</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="databox-top bg-whitesmoke no-padding">
                    ...
                    <div class="databox-row row-4">
                        <div class="databox-cell cell-6 no-padding padding-10 padding-left-20 text-align-left">
                            <span id="overalview" runat="server" class="databox-number orange no-margin">534,908</span>
                        ...
                        <div class="databox-cell cell-2 no-padding padding-10 text-align-left">
                            <span id="thisview" runat="server" class="databox-number orange no-margin">4,129</span>
                            <span class="databox-text darkgray no-margin">THIS WEEK</span>
                        </div>
                        <div class="databox-cell cell-2 no-padding padding-10 text-align-left">
                            <span id="yesterdayview" runat="server" class="databox-number orange no-margin">329</span>
                            <span class="databox-text darkgray no-margin">YESTERDAY</span>
                        </div>
                        <div class="databox-cell cell-2 no-padding padding-10 text-align-left">
                            <span id="todayview" runat="server" class="databox-number orange no-margin">104</span>
