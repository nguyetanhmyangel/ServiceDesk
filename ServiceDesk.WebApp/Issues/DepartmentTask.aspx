<%@ Page Title="Xử lí yêu cầu" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="DepartmentTask.aspx.cs" Inherits="ServiceDesk.WebApp.Issues.DepartmentTask" %>
    ...
    <div class="widget">
        ...
        <div class="widget-body bordered-left">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <telerik:RadComboBox ID="rcbDepartment" runat="server" Width="100%"
                            HighlightTemplatedItems="true" AutoPostBack="true" EmptyMessage="Chọn một phòng ban"
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView Name="Master"  TableLayout="Fixed" InsertItemPageIndexAction="ShowItemOnCurrentPage" 
                    DataKeyNames="Id" EditMode="PopUp" CommandItemDisplay="Top"
                    ...
                    <DetailTables>
                        <telerik:GridTableView CommandItemDisplay="None" DataKeyNames="Id" Name="Detail" Width="100%">
                            <%--<ParentTableRelation>
                                <telerik:GridRelationFields DetailKeyField="IssueId" MasterKeyField="Id" />
                            </ParentTableRelation>--%>
                            <DetailTables>
                                <telerik:GridTableView DataKeyNames="IssueId" Name="ChildDetail" Width="100%">
                                    <%--<ParentTableRelation>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn FilterControlAltText="Filter UserName column" 
                                            UniqueName="UserName" HeaderText="Mã nhân viên" DataField="UserName" ReadOnly="true" Display="false">
                                            <HeaderStyle Width="120px" />
                                            <ItemStyle Width="120px" />
                                        </telerik:GridBoundColumn>

                                        <telerik:GridTemplateColumn HeaderText="Họ tên" EnableHeaderContextMenu="false"
                                            FilterControlAltText="Filter FullName column"
                                            SortExpression="FullName" CurrentFilterFunction="StartsWith"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <telerik:RadToolTip RenderMode="Lightweight" ID="RadToolTipFullName" runat="server"
                                        ...
                                        <telerik:GridDateTimeColumn DataField="FinishDate" HeaderText="Ngày hoàn thành" DataFormatString="{0:dd/MM/yyyy}" 
                                            SortExpression="FinishDate" CurrentFilterFunction="StartsWith" ShowFilterIcon="false" AllowFiltering="false"
                                            UniqueName="FinishDate" ReadOnly="true" Display="true" DataType="System.DateTime">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Ghi chú" EnableHeaderContextMenu="false"
                                            FilterControlAltText="Filter ChildDetailDescription column"
                                            SortExpression="Title" CurrentFilterFunction="StartsWith"
                                            ShowFilterIcon="false" AllowFiltering="true" UniqueName="Title">
                                            <ItemTemplate>
                                                <asp:Label ID="lbChildDetailDescription" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                                                <telerik:RadToolTip RenderMode="Lightweight" ID="RadToolTiplbChildDetailDescription" runat="server"
                                                    TargetControlID="lbChildDetailDescription" Width="400px"
                                                    RelativeTo="Element" Position="MiddleRight" BorderColor="OrangeRed" ForeColor="Blue">
                            ...
                            <Columns>
                                ...
                                <telerik:GridDateTimeColumn DataField="StartDate" HeaderText="Bắt đầu" DataFormatString="{0:dd/MM/yyyy}"
                                    ...
                                    UniqueName="StartDate" ReadOnly="true" Display="true" DataType="System.DateTime">
                                ...
                                <telerik:GridDateTimeColumn DataField="EndDate" HeaderText="Kết thúc" DataFormatString="{0:dd/MM/yyyy}"
                                    ...
                                    UniqueName="EndDate" ReadOnly="true" Display="true" DataType="System.DateTime">
                                    <HeaderStyle Width="100px" />
                                    <ItemStyle Width="100px" />
                                    <ColumnValidationSettings></ColumnValidationSettings>
                                </telerik:GridDateTimeColumn>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn FilterControlAltText="Filter IssueStatusId column"
                            UniqueName="IssueStatusId" HeaderText="StatusId" DataField="IssueStatusId" ReadOnly="true" Display="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridTemplateColumn HeaderText="Tình trạng" EnableHeaderContextMenu="false"
                            UniqueName="IssueStatusName" FilterControlAltText="Filter IssueStatusName column"
                            SortExpression="IssueStatusName" CurrentFilterFunction="StartsWith"
                            ShowFilterIcon="false" AllowFiltering="true" ReadOnly="true">
                            <ItemTemplate>
                                <asp:Label ID="lbStatus" Width="90px" runat="server" Text='<%# Eval("IssueStatusName") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Width="120px" HorizontalAlign="Center" />
                            <ItemStyle Width="120px" HorizontalAlign="Center" />
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ưu tiên" EnableHeaderContextMenu="false"
                            FilterControlAltText="Filter IssuePriorityId column"
                            SortExpression="IssuePriorityId" CurrentFilterFunction="StartsWith"
                            ShowFilterIcon="false" AllowFiltering="true" UniqueName="IssuePriorityId">
                            <ItemTemplate>
                                <asp:HiddenField ID="hdPriorityId" runat="server" Value='<%# Eval("IssuePriorityId") %>' />
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                                    <div class="widget">
                                                        <div class="widget-header bordered-bottom bordered-pink">
                                                            <span class="widget-caption">Xử lí yêu cầu <%# CustomizeEval() %> </span>
                                                        </div>
                                                        <div class="widget-body">
                                                                ...
                                                                <div class="form-horizontal">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <telerik:RadMultiSelect ID="OtherDepartments" runat="server" RenderMode="Lightweight" Filter="Contains" Width="100%" AutoPostBack="true"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <telerik:RadMultiSelect ID="Users" runat="server" Filter="Contains" Width="100%"
                                                                                DataTextField="FullName" DataValueField="UserId" OnItemDataBound="Users_ItemDataBound">
                                                                                <HeaderTemplate>
                                                                            <div class="dropdown-header k-widget k-header"> 
                                                                                ...
                                                                                <FooterTemplate>
                                                                            Tổng #: instance.dataSource.total() # số dòng tìm thấy
                                                                                </FooterTemplate>
                                                                                <NoDataTemplate>
                                                                            Ko tìm thấy nhân viên nào.
                                                                                </NoDataTemplate>
                                                                                <ItemTemplate>
                                                                            <div class="dropdown-item"> 
                                                                                <span>#: data.FullName #</span>
                                                                                <span>#: attributes.CountExecuting #</span>
                                                                            </div>
                                                                                </ItemTemplate>
                                                                            </telerik:RadMultiSelect>
                                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:HiddenField ID="hdTaskId" runat="server" Value='<%# Eval("TaskId") %>' />
                ...
                <ClientSettings >
                    <Scrolling AllowScroll="True" ScrollHeight="" FrozenColumnsCount="4" UseStaticHeaders="True" 
                        SaveScrollPosition="true" EnableNextPrevFrozenColumns="true"></Scrolling>
                </ClientSettings>
