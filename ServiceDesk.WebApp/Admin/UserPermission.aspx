<%@ Page Title="User permission" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="UserPermission.aspx.cs" Inherits="ServiceDesk.WebApp.Admin.UserPermission" %>
    ...
    <div class="widget">
        ...
        <div class="widget-body bordered-left">
            <div class="form-inline" role="form">
                <div class="row">
                    <div class="col-md-4">
                        <telerik:RadComboBox ID="rcbUser" runat="server" Width="100%"
                            HighlightTemplatedItems="true" AutoPostBack="true" 
                            EnableLoadOnDemand="true" Filter="Contains" 
                            OnSelectedIndexChanged="rcbUser_SelectedIndexChanged"
                            DataTextField="UserName" DataValueField="RoleId" EnableItemCaching="true"
                            ItemsPerRequest="10" ShowMoreResultsBox="true" EnableVirtualScrolling="true" Skin="Office2010Blue">
                            <HeaderTemplate>
                                <table>
                                    <tr>
                                        <td style="color: Black; width: 70px;">UserId
                                        </td>
                                        <td style="color: Black;">UserName
                                        </td>
                                    </tr>
                                </table>
                            </HeaderTemplate>
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn FilterControlAltText="Filter Add column"
                        ...
                        <ItemTemplate>
                            <div class="checkbox">
                                <label>
                                    <asp:CheckBox id="chkAdd" runat="server" Checked='<%# CheckedAdd(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "UserPermission"))) %>'></asp:CheckBox>
                    ...
                    <telerik:GridTemplateColumn FilterControlAltText="Filter Edit column" ShowFilterIcon="false" 
                        ...
                        <ItemTemplate>
                            <div class="checkbox">
                                <label>
                                    <asp:CheckBox id="chkEdit" runat="server" Checked='<%# CheckedEdit(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "UserPermission"))) %>'></asp:CheckBox>
                                    <span class="text"></span>
                                </label>
                            </div>
                        </ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn FilterControlAltText="Filter Delete column"
                        ...
                        <ItemTemplate>
                            <div class="checkbox">
                                <label>
                                    <asp:CheckBox id="chkDelete" runat="server" Checked='<%# CheckedDelete(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "UserPermission"))) %>'></asp:CheckBox>
                                    <span class="text"></span>
                                </label>
                            </div>
                        </ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn FilterControlAltText="Filter View column"
                        ...
                        <ItemTemplate>
                            <div class="checkbox">
                                <label>
                                    <asp:CheckBox id="chkView" runat="server" Checked='<%# CheckedView(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "UserPermission"))) %>'></asp:CheckBox>
                                    <span class="text"></span>
                                </label>
                            </div>
                        </ItemTemplate>
