...
window.Chart = function(context) {
    ...
    var PolarArea = function(data, config, ctx) {
        ...
        if (!config.scaleOverride) {
            ...
            calculatedScale = calculateScale(scaleHeight,
            ...
            populateLabels(labelTemplateString,
                    ...
                    if (config.scaleShowLabelBackdrop) {
                        ...
                        ctx.rect(
                            ...
                            Math.round(height / 2 -
                                ...
                                config.scaleBackdropPaddingY), //Y
    ...
    var Radar = function(data, config, ctx) {
        ...
        function drawAllDataPoints(animationDecimal) {
            ...
            for (var i = 0; i < data.datasets.length; i++) {
                ...
                ctx.moveTo(0,
                    animationDecimal * (-1 * calculateOffset(data.datasets[i].data[0], calculatedScale, scaleHop)));
                for (var j = 1; j < data.datasets[i].data.length; j++) {
                    ctx.rotate(rotationDegree);
                    ctx.lineTo(0,
                        animationDecimal * (-1 * calculateOffset(data.datasets[i].data[j], calculatedScale, scaleHop)));
                ...
                if (config.pointDot) {
                    ...
                    for (var k = 0; k < data.datasets[i].data.length; k++) {
                        ...
                        ctx.arc(0,
                            animationDecimal *
                            (-1 * calculateOffset(data.datasets[i].data[k], calculatedScale, scaleHop)),
        ...
        function drawScale() {
                ...
                if (config.scaleShowLabels) {
                    ...
                    if (config.scaleShowLabelBackdrop) {
                        ...
                        ctx.rect(
                            ...
                            Math.round(
                                (-scaleHop * (i + 1)) - config.scaleFontSize * 0.5 - config.scaleBackdropPaddingY), //Y
                            Math.round(textWidth + (config.scaleBackdropPaddingX * 2)), //Width
                            Math.round(config.scaleFontSize + (config.scaleBackdropPaddingY * 2)) //Height
                        );
                        ctx.fill();
            ...
            for (var k = 0; k < data.labels.length; k++) {
                ctx.font = config.pointLabelFontStyle +
                    " " +
    ...
    var Line = function(data, config, ctx) {
        ...
        function drawLines(animPc) {
            ...
            function yPos(dataSet, iteration) {
                return xAxisPosY -
                    animPc * (calculateOffset(data.datasets[dataSet].data[iteration], calculatedScale, scaleHop));
            }
    ...
    function animationLoop(config, drawScale, drawData, ctx) {
        ...
        function animateFrame() {
            var easeAdjustedAnimationPercent =
                (config.animation) ? CapValue(easingFunction(percentAnimComplete), null, 0) : 1;
            clear(ctx);
