(function() {
            ...
            if (this.options.axes === true || this.options.grid === true) {
                if (this.options.ymax === this.gridDefaults.ymax && this.options.ymin === this.gridDefaults.ymin) {
                    ...
                    this.grid = (function() {
                        ...
                        _results = [];
                        for (y = _i = _ref = this.ymin, _ref1 = this.ymax;
            ...
            if (this.elementWidth !== w || this.elementHeight !== h || this.dirty) {
                ...
                if (this.options.axes) {
                    ...
                    bottomOffsets = (function() {
                        ...
                        _results = [];
                        for (i = _i = 0, _ref = this.data.length;
    ...
    Morris.Line = (function(_super) {
        ...
        Line.prototype.calcPoints = function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                _results.push(row._ymax = Math.min.apply(null,
        ...
        Line.prototype._drawPointFor = function(index) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (row._y[index] != null) {
                    circle = this.drawLinePoint(row._x,
                        row._y[index],
        ...
        Line.prototype.drawLinePoint = function(xPos, yPos, size, pointColor, lineIndex) {
            return this.raphael.circle(xPos, yPos, size).attr("fill", pointColor)
    ...
    Morris.AUTO_LABEL_ORDER = [
        "decade", "year", "month", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec",
        "10sec", "5sec", "second"
    ];
