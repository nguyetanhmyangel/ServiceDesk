...
! function(t) {
    var e = function(e, i) {
        this.$element = t(e), this.options = t.extend({}, t.fn.tree.defaults, i), this.$element.on("click",
            ".tree-item",
            t.proxy(function(t) {
                    this.selectItem(t.currentTarget);
                },
                this)), this.$element.on("click",
            ".tree-folder-header",
            t.proxy(function(t) {
    ...
    e.prototype = {
        ...
        populate: function(e) {
            ...
            r.show(), this.options.dataSource.data(e.data(),
                function(o) {
                    r.hide(), t.each(o.data,
                        function(r, o) {
                            var s;
                            "folder" === o.type
                                ? (s = i.$element.find(".tree-folder:eq(0)").clone().show(),
                                ...
                                /*Addedd For Custom Icon Class*/
                                "item" === o.type &&
                                (s = i.$element.find(".tree-item:eq(0)").clone().show(),
                            ...
                            t.each(a,
                                ...
                                }), e.hasClass("tree-folder-header")
                                ? n.find(".tree-folder-content:eq(0)").append(s)
                                : e.append(s);
        ...
        selectItem: function(e) {
            ...
            if (this.options.multiSelect
                ...
                (n.removeClass("tree-selected").find("i").removeClass("fa fa-check-square-o").addClass("tree-dot"),
                    r.push(i.data())), this.options.selectable) {
                var o = "selected";
                i.hasClass("tree-selected")
                    ? (o =
                            "unselected", i.removeClass("tree-selected"),
                    ...
                    : (i.addClass("tree-selected"),
                        ...
                        this.options.multiSelect && r.push(i.data()));
            }
            r.length &&
        ...
        selectFolder: function(e) {
            var i,
                ...
                l = a.eq(0);
            o.find(".fa.fa-folder").length
                ? (i = "opened", n = ".fa.fa-folder", r =
                    "fa fa-folder-open", l.show(), a.children().length || this.populate(o))
                : (i = "closed", n = ".fa.fa-folder-open", r =
                    "fa fa-folder", l.hide(), this.options.cacheItems || l.empty()), s.find(n).eq(0)
                .removeClass("fa fa-folder fa-folder-open").addClass(r), this.$element.trigger(i, o.data());
        },
