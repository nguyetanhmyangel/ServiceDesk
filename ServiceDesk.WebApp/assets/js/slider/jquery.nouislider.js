...
// API
        ...
        function create(options) {
            ...
            return this.each(function() {
                ...
                target.data("base", base).addClass([
                    clsList[6], clsList[16 + options["direction"]], clsList[10 + options["orientation"]]
                ].join(" "));
        ...
        function destroy(target) {
            ...
            $.each(target.data("base").data("handles"),
                function() {
