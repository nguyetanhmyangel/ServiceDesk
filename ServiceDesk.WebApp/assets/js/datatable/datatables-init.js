    ...
    return {
        init: function() {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[4].innerHTML =
                    '<a href="#" class="btn btn-success btn-xs save"><i class="fa fa-save"></i> Save</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> Cancel</a>';
            }
    ...
    return {
        init: function() {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = "<table>";
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;"><img src="assets/img/avatars/' +
                    aData[6] +
                    '"/></td><td>Name:</td><td>' +
                    aData[1] +
                    "</td></tr>";
